<?php
//*Se requiere que el usuario ingrese las 4 notas luego el sistema verifica y determina si esta reprobado o aprobado
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <center>
   <header> 
  <h1 style="color: #77DD77; font-size: 36px">PROMEDIO DE LAS 4 MEJORES NOTAS</h1>
  <header>
    <main> 
        <section>
